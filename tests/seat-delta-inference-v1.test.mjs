...
import { inferSeatAction } from '../src/core/seat-delta-inference.js';
...
assert.equal(inferSeatAction({cardsPresent:true,commitment:0,turn:true},{cardsPresent:true,commitment:0,turn:false}).action,'CHECK');
