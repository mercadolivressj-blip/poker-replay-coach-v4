...
import { buildValidatedHighRakeSidecar, validateHighRakeManifest, validateHighRakeResume } from '../scripts/lib/cash-pro-lab-highrake-runner.mjs';
...
function solution(r){
  ...
  return {
    ...
    meta:{iterations:1000,exploitability_chips:0.01,exploitability_pct_of_pot:0.2,root_evs:{zero_sum:[-0.1,0.05],pot_share:[2.6,2.65]},wall_seconds:1,engine_version:'fixture',payoff_unit:'chips',gain:[0.005,0.005]},
...
test('high-rake manifest rejects provider or rake contract drift',()=>{
  const r=row();
