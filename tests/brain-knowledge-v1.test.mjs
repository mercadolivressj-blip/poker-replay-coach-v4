...
const k=buildBrainKnowledge(state,{ledger,profiles});
assert.equal(k.version,'brain-knowledge-v1');
...
const r=decideBrain(state,{format:'cash',handId:41,heroActor:'Hero',profiles});
assert.equal(r.knowledgeVersion,'brain-knowledge-v1');
