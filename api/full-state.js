...
function prompt() {
  return [
    ...
    'Cash formatting matters: "US$ 0,12" => numeric 0.12. Re-read the central Pote digits once before returning JSON.',
    'Cross-check the central pot against visible committed chips. The pot cannot be smaller than the sum of clearly visible contributions already included. If the numbers conflict, re-read and lower potConfidence rather than guessing.',
