...
function prompt() {
  return [
    ...
    'Pot: read only the central pot label. Portuguese decimal comma is decimal, e.g. US$ 0,12 = 0.12. Re-check the central pot label before answering so a player contribution is never mistaken for the pot.',
