...
function prompt() {
  return [
    ...
    'aggressorName: identify the opponent currently responsible for the largest live wager hero is facing, using explicit Bet/Raise action text or the largest visible committed-chip label. If no such opponent can be identified, return null.',
