...
clearPacks();
const baseMeta={game:'NLHE',format:'MTT',mode:'cEV',tableSize:8,stackDepthBB:10,depthPolicy:'exact',node:'vs_open',heroPosition:'BB',villainPosition:'SB',source:'internal pushfold regression',sourceType:'internal-pushfold-solver',referenceDate:'2026-09-24',certification:'solver-verified',actionSet:['FOLD','CALL'],contextPolicy:'exact-preflop-forced'};
...
console.log('PASS — context-sensitive strategy packs refuse ante/table-context mismatch');
