// Ported into Cash Pro Lab from the independently regression-tested MTT evaluator.
// The lab keeps its own copy so Cash experiments remain isolated from MTT runtime.
